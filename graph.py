...
def graph():
    ...
    c = f"This study use web scraping in order to get the data from the main sellers of real estate" \
        ...
        f"The study have the values of {value_counts} properties ubicated in Cortes, Honduras. The mean price of" \
        ...
        f"is {value_count2}. Using this set of data, I take the mean price of the data, " \
